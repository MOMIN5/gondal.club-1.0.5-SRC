...
public class Slider extends Button
{
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        esohack.textManager.drawStringWithShadow(this.getName() + " " + "§7" + ((this.setting.getValue() instanceof Float) ? this.setting.getValue() : Double.valueOf(this.setting.getValue().doubleValue())), this.x + 2.3f, this.y - 1.7f - esohackGui.getClickGui().getTextOffset(), -1);
    }
